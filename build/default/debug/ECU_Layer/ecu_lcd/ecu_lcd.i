...
# 12 "ECU_Layer/ecu_lcd/ecu_lcd.c"
# 1 "ECU_Layer/ecu_lcd/ecu_lcd.h" 1
# 17 "ECU_Layer/ecu_lcd/ecu_lcd.h"
# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/hal_gpio.h" 1
# 14 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/hal_gpio.h"
...
# 14 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/hal_gpio.h" 2
...
# 15 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/hal_gpio.h" 2
...
# 16 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/hal_gpio.h" 2
...
# 17 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/hal_gpio.h" 2

# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/../pic18f4620_lib/pic18f4620.h" 1
# 18 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/hal_gpio.h" 2

# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/../mcal_std_types/mcal_std_types.h" 1
# 28 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/../mcal_std_types/mcal_std_types.h"
...
# 45 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/../mcal_std_types/mcal_std_types.h"
...
# 19 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/hal_gpio.h" 2

# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/../device_config/device_config.h" 1
# 16 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/../device_config/device_config.h"
...
# 20 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/hal_gpio.h" 2

# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/hal_gpio_cfg.h" 1
# 21 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/hal_gpio.h" 2

# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/../compiler.h" 1
# 11 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/../compiler.h"
...
# 11 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/../compiler.h" 2
# 22 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/hal_gpio.h" 2
...
# 41 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio/hal_gpio.h"
typedef struct {
    uint8_t pin : 3;
    uint8_t port : 3;
    uint8_t direction : 1;
...
# 17 "ECU_Layer/ecu_lcd/ecu_lcd.h" 2

# 1 "ECU_Layer/ecu_lcd/ecu_lcd_cfg.h" 1
# 18 "ECU_Layer/ecu_lcd/ecu_lcd.h" 2
# 141 "ECU_Layer/ecu_lcd/ecu_lcd.h"
typedef struct
{
...
# 12 "ECU_Layer/ecu_lcd/ecu_lcd.c" 2
...
std_returntype lcd_4bit_initialize(lcd_4bit_t *__lcd)
{
    ...
    else
    {
        ...
        ret |= lcd_4bit_send_command(__lcd, (((0x30)) | ((((0x28)) | ((0x28))))));
        _delay((unsigned long)((20)*(8000000/4000.0)));
        ret |= lcd_4bit_send_command(__lcd, (((0x30)) | ((((0x28)) | ((0x28))))));
        _delay((unsigned long)((5)*(8000000/4000.0)));
        ret |= lcd_4bit_send_command(__lcd, (((0x30)) | ((((0x28)) | ((0x28))))));
        _delay((unsigned long)((150)*(8000000/4000000.0)));
        ret |= lcd_4bit_send_command(__lcd, (0x01));
        ret |= lcd_4bit_send_command(__lcd, (0x02));
        ret |= lcd_4bit_send_command(__lcd, (((0x06)) | ((0x04))));
        ret |= lcd_4bit_send_command(__lcd, (((0x0C)) | ((((0x08)) | ((0x08))))));
        ret |= lcd_4bit_send_command(__lcd, (((0x20)) | ((((0x28)) | ((0x28))))));
...
std_returntype lcd_4bit_send_command(lcd_4bit_t *__lcd, uint8_t __command)
{
    ...
    else
    {
        ...
        ret |= lcd_send_4bit(__lcd, ((__command >> 4) & 0x0F));
        ret |= lcd_4bit_send_enable_signal(__lcd);
        ret |= lcd_send_4bit(__lcd, ((__command >> 0) & 0x0F));
        ret |= lcd_4bit_send_enable_signal(__lcd);
    }
    return ret;
}
...
std_returntype lcd_4bit_send_data(lcd_4bit_t *__lcd, uint8_t __data)
{
    ...
    else
    {
        ...
        ret |= lcd_send_4bit(__lcd, ((__data >> 4) & 0x0F));
        ret |= lcd_4bit_send_enable_signal(__lcd);
        ret |= lcd_send_4bit(__lcd, ((__data >> 0) & 0x0F));
        ret |= lcd_4bit_send_enable_signal(__lcd);
    }
    return ret;
}
...
std_returntype lcd_4bit_send_custom_char_pos(lcd_4bit_t *__lcd, uint8_t __row, uint8_t __column, uint8_t __ch[], uint8_t __mem_pos)
{
    ...
    {
        __mem_pos--;
        ret |= lcd_4bit_send_command(__lcd, ((0x40) + (__mem_pos * 8)));
...
std_returntype lcd_4bit_shift(lcd_4bit_t *__lcd, lcd_display_shift_cfg_t *__shift)
{
    ...
    {
        ret |= lcd_4bit_send_command(__lcd, (((0x06)) | ((0x05))));
        switch (__shift->mode)
        {
        case AUTO_SHIFT_ON:
            for (shift_counter = 0;
                 ...
                 shift_counter++)
            {
                ...
                {
                    ret |= lcd_4bit_send_command(__lcd, (((0x18)) | ((0x10))));
                }
                else
                {
                    ret |= lcd_4bit_send_command(__lcd, (((0x18)) | ((0x14))));
                }
...
std_returntype lcd_4bit_behavior(lcd_4bit_t *__lcd, lcd_behavior_t __behavior)
{
    ...
    else
    {
        ...
        case LCD_DISPLAY_ON_BEHAVIOR:
            ret |= lcd_4bit_send_command(__lcd, (0x0C));
            break;
        case LCD_DISPLAY_OFF_BEHAVIOR:
            ret |= lcd_4bit_send_command(__lcd, (0x08));
            break;
        case LCD_RETURN_HOME_BEHAVIOR:
            ret |= lcd_4bit_send_command(__lcd, (0x02));
            break;
        case LCD_NEXT_CHAR_INCREMENT:
            ret |= lcd_4bit_send_command(__lcd, (0x06));
            break;
        case LCD_NEXT_CHAR_DECREMENT:
            ret |= lcd_4bit_send_command(__lcd, (0x04));
            break;
        case LCD_SHOW_UNDERLINE_CURSOR:
            ret |= lcd_4bit_send_command(__lcd, (((0x0C)) | ((0x0A))));
            break;
        case LCD_HIDE_UNDERLINE_CURSOR:
            ret |= lcd_4bit_send_command(__lcd, (((0x0C)) | ((0x08))));
            break;
        case LCD_SHOW_CURSOR_BLINK:
            ret |= lcd_4bit_send_command(__lcd, (((0x0C)) | ((0x09))));
            break;
...
std_returntype lcd_8bit_initialize(lcd_8bit_t *__lcd)
{
    ...
    else
    {
        ...
        ret |= lcd_8bit_send_command(__lcd, (((0x30)) | ((((0x28)) | ((0x28))))));
        _delay((unsigned long)((20)*(8000000/4000.0)));
        ret |= lcd_8bit_send_command(__lcd, (((0x30)) | ((((0x28)) | ((0x28))))));
        _delay((unsigned long)((5)*(8000000/4000.0)));
        ret |= lcd_8bit_send_command(__lcd, (((0x30)) | ((((0x28)) | ((0x28))))));
        _delay((unsigned long)((150)*(8000000/4000000.0)));
        ret |= lcd_8bit_send_command(__lcd, (0x01));
        ret |= lcd_8bit_send_command(__lcd, (0x02));
        ret |= lcd_8bit_send_command(__lcd, (((0x06)) | ((0x04))));
        ret |= lcd_8bit_send_command(__lcd, (((0x0C)) | ((((0x08)) | ((0x08))))));
        ret |= lcd_8bit_send_command(__lcd, (((0x30)) | ((((0x28)) | ((0x28))))));
...
std_returntype lcd_8bit_send_custom_char_pos(lcd_8bit_t *__lcd, uint8_t __row, uint8_t __column, uint8_t __ch[], uint8_t __mem_pos)
{
    ...
    {
        __mem_pos--;
        ret |= lcd_8bit_send_command(__lcd, ((0x40) + (__mem_pos * 8)));
...
std_returntype lcd_8bit_shift(lcd_8bit_t *__lcd, lcd_display_shift_cfg_t *__shift)
{
    ...
    {
        ret |= lcd_8bit_send_command(__lcd, (((0x06)) | ((0x05))));
        switch (__shift->mode)
        {
        case AUTO_SHIFT_ON:
            for (shift_counter = 0;
                 ...
                 shift_counter++)
            {
                if (__shift->direction == DISPLAY_SHIFT_LEFT)
                {
                    ret |= lcd_8bit_send_command(__lcd, (((0x18)) | ((0x10))));
                }
                else
                {
                    ret |= lcd_8bit_send_command(__lcd, (((0x18)) | ((0x14))));
                }
                for(duration_counter = 0; duration_counter < __shift->configurations.auto_shift_on.duration; duration_counter++)
                {
                    _delay((unsigned long)((1)*(8000000/4000.0)));
...
std_returntype lcd_48it_behavior(lcd_8bit_t *__lcd, lcd_behavior_t __behavior)
{
    ...
    else
    {
        ...
        case LCD_DISPLAY_CLEAR_BEHAVIOR:
            ...
            break;
        case LCD_DISPLAY_ON_BEHAVIOR:
            ret |= lcd_8bit_send_command(__lcd, (0x0C));
            break;
        case LCD_DISPLAY_OFF_BEHAVIOR:
            ret |= lcd_8bit_send_command(__lcd, (0x08));
            break;
        case LCD_RETURN_HOME_BEHAVIOR:
            ret |= lcd_8bit_send_command(__lcd, (0x02));
            break;
        case LCD_NEXT_CHAR_INCREMENT:
            ret |= lcd_8bit_send_command(__lcd, (0x06));
            break;
        case LCD_NEXT_CHAR_DECREMENT:
            ret |= lcd_8bit_send_command(__lcd, (0x04));
            break;
        case LCD_SHOW_UNDERLINE_CURSOR:
            ret |= lcd_8bit_send_command(__lcd, (((0x0C)) | ((0x0A))));
            break;
        case LCD_HIDE_UNDERLINE_CURSOR:
            ret |= lcd_8bit_send_command(__lcd, (((0x0C)) | ((0x08))));
            break;
        case LCD_SHOW_CURSOR_BLINK:
            ret |= lcd_8bit_send_command(__lcd, (((0x0C)) | ((0x09))));
            break;
        case LCD_HIDE_CURSOR_BLINK:
            ret |= lcd_8bit_send_command(__lcd, (((0x0C)) | ((0x08))));
            break;
...
static std_returntype lcd_4bit_set_cursor(lcd_4bit_t *__lcd, uint8_t __row, uint8_t __column)
{
    ...
    else
    {
        ...
        case (1):
            ret |= lcd_4bit_send_command(__lcd, ((0x80) + __column));
            break;



        case (2):
            ret |= lcd_4bit_send_command(__lcd, ((0xC0) + __column));
            break;



        case (3):
            ret |= lcd_4bit_send_command(__lcd, ((0x95) + __column));
            break;



        case (4):
            ret |= lcd_4bit_send_command(__lcd, ((0xD5) + __column));
            break;
...
static std_returntype lcd_8bit_set_cursor(lcd_8bit_t *__lcd, uint8_t __row, uint8_t __column)
{
    ...
    else
    {
        ...
        case (1):
            ret |= lcd_8bit_send_command(__lcd, ((0x80) + __column));
            break;



        case (2):
            ret |= lcd_8bit_send_command(__lcd, ((0xC0) + __column));
            break;



        case (3):
            ret |= lcd_8bit_send_command(__lcd, ((0x95) + __column));
            break;



        case (4):
            ret |= lcd_8bit_send_command(__lcd, ((0xD5) + __column));
            break;
